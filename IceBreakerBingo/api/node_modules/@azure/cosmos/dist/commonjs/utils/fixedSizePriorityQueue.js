...
var fixedSizePriorityQueue_exports = {};
__export(fixedSizePriorityQueue_exports, {
  FixedSizePriorityQueue: () => FixedSizePriorityQueue
});
module.exports = __toCommonJS(fixedSizePriorityQueue_exports);
...
class FixedSizePriorityQueue {
  ...
  constructor(compareFn, pqMaxSize) {
    ...
    this.pq = new import_priorityqueuejs.default(this.compareFn);
