...
__export(ClientUtils_exports, {
  computePartitionKeyRangeId: () => computePartitionKeyRangeId,
  readPartitionKeyDefinition: () => readPartitionKeyDefinition
});
module.exports = __toCommonJS(ClientUtils_exports);
...
async function computePartitionKeyRangeId(diagnosticNode, partitionKey, partitionKeyRangeCache, isPartitionLevelFailOverEnabled, container, pKDefinition) {
  let partitionKeyRangeId = void 0;
