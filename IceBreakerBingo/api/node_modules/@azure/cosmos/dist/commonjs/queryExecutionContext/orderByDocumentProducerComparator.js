...
var orderByDocumentProducerComparator_exports = {};
__export(orderByDocumentProducerComparator_exports, {
  OrderByDocumentProducerComparator: () => OrderByDocumentProducerComparator
});
module.exports = __toCommonJS(orderByDocumentProducerComparator_exports);
...
class OrderByDocumentProducerComparator {
  ...
  targetPartitionKeyRangeDocProdComparator(docProd1, docProd2) {
    ...
    return epkA !== void 0 && epkB !== void 0 ? epkA < epkB ? -1 : epkA > epkB ? 1 : 0 : 0;
  }
